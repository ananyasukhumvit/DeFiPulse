 ...
 * This file demonstrates how to integrate Defipulse with a web frontend
 */

// For React/Vue/Angular applications
export class DefipulseClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DefipulseClient(provider, contractAddress);
